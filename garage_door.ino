...
void handleRoot() {
  ...
  txt += "</style>\n";
  txt += "<script>\n";
  txt += "var refreshFuction;\n";
  txt += "var refreshInterval = 5000;\n";
  ...
  txt += "  clearInterval(refreshFuction);\n";
  txt += "  document.getElementById('activate-btn').disabled = true;\n";
  txt += "  if (confirm('This action will activate the garage door.') == true) { \n";
  ...
  txt += "    })\n";
  txt += "    .finally( () => { \n";
  txt += "      refreshFuction = setInterval(updateStatus, refreshInterval);\n";
  txt += "    });\n";
  txt += "  }\n";
  txt += "  document.getElementById('activate-btn').disabled = false;\n";
  txt += "}\n";
  txt += "updateStatus(); \n";
  txt += "refreshFuction = setInterval(updateStatus, refreshInterval); \n";
